"""
This file Retrieved from: https://github.com/pytorch/vision/blob/master/torchvision/models/inception.py
"""
...
class Inception3(nn.Module):
    ...
    def truncated_normal_(tensor, mean=0.0, std=1.0):
        """
        Retrieved from: https://discuss.pytorch.org/t/implementing-truncated-normal-initializer/4778/16
        """
        size = tensor.shape
    ...
    def load_pre_train_weights(self, progress):
        # Load model weight
    ...
    def _freeze_layers(self, freeze_until):
        """
        Freeze parameters until the specified layer.
        e.g.
          No frozen layers if freeze_until is -1.
          The first layer is frozen if freeze_until is 0.
        """
